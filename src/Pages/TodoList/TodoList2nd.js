...
const TodoList2nd = ({input, setInput, taskEdit, setTaskEdit }) => {
    ...
    const updateTask = ({taskEdit, task})=>{
        console.log(taskEdit)

        fetch(`https://daily-task-22.herokuapp.com/task/${taskEdit._id}`, {
                method: 'PUT',
                headers: {
    ...
    return (
        <div className="card min-h-[500px] h-screen w-[80%] my-5 md:w-[70%] lg:w-1/2 mx-auto bg-accent border-2 shadow-xl">
            <div className="card-body ">
                ...
                <h2 className=" font-bold my-3 text-transparent text-4xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600 text-center ">To Do List 2nd</h2>
                <form onSubmit={addTask} className='flex mx-12 justify-center'>
                <input className='bg-orange-100 w-[70%] rounded-l-lg sm:w-full p-2' name='task' type="text" placeholder="Enter a Todo" value={input} required                
